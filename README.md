...
а ИИ-тренер на базе LLM (DeepSeek / GigaChat) составляет программу тренировок, разбирает технику
...
Сделан как курсовой проект по проектному практикуму (УрФУ, 4 семестр) командой из пяти человек за шесть
...
| БД | PostgreSQL 15 |
| ИИ | DeepSeek / GigaChat (LLM), парсинг `<workout>` из ответа |
...
Курсовой проект, проектный практикум, УрФУ, 4 семестр.

| Участник | Роль |
|---|---|
| Danila | тимлид, DevOps, тренировки/таймер, ИИ-тренер |
| Данил | backend, все API-эндпоинты |
| Влад | парсер базы знаний, синхронизация упражнений, изображения |
| Ника | профиль, настройки, layout, регистрация, лендинг |
| Даша | база знаний, сетка упражнений |
</content>
